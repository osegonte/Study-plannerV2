...
const WorkingPDFViewer = ({ documentId, fileName, onBack }) => {
  const [pageNumber, setPageNumber] = useState(1);
  const [scale, setScale] = useState(1.0);
  
  // WORKING Timer state
  const [isTracking, setIsTracking] = useState(true); // Auto-start
  ...
  const generatePageContent = () => {
    const isEconomics = fileName.toLowerCase().includes('economic') || fileName.toLowerCase().includes('supply') || fileName.toLowerCase().includes('demand');
    ...
    if (isEconomics) {
      return {
        ...
        content: [
          ...
          "",
          `Page ${pageNumber} continues the analysis of these fundamental economic relationships and their real-world applications.`
        ]
      };
    } else if (isMath) {
      return {
        ...
        content: [
          ...
          "",
          "These concepts form the basis for advanced mathematical analysis and applications in science and engineering.",
          "",
          `This is page ${pageNumber} of ${displayPages} in your study material.`
        ]
      };
    } else {
      return {
        ...
        content: [
          ...
          "",
          "Educational Content:",
          "This PDF viewer demonstrates the study planner's capabilities including:",
          "",
          ...
          "",
          "The timer is currently tracking your reading time for this page. Navigate to other pages to see how the system saves your progress.",
          "",
